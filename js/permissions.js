...
const REVIBE_ACTION_PERMISSION_RULES={
  recordBedSession:['daily_session_tracker','edit'], deleteBedSessionFromHistory:['daily_session_tracker','delete'], deleteDailySession:['daily_session_tracker','delete'], deleteBedSessionFromModal:['daily_session_tracker','delete'], deleteDailySessionFromEdit:['daily_session_tracker','delete'],
  ...
  openNewCustomerWizard:['treatment_booking_settings','edit'], wizCreateAccount:['treatment_booking_settings','edit'], wizConfirmPurchases:['daily_session_tracker','edit'], wizRecordSession:['daily_session_tracker','edit'], openExistingCustomerWizard:['daily_session_tracker','edit'],
  ...
  openCleaningTaskEdit:['apartment_cleans','edit'], openOrCreateTaskForCell:['apartment_cleans','edit'], syncAirbnbCalendars:['apartment_cleans','edit'],
  saveBookingDetail:['my_bookings','edit'], deleteMyBooking:['my_bookings','delete'], createBookingFromMyBookings:['my_bookings','edit'], openBookingForClinician:['my_bookings','edit'],
