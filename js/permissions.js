...
const REVIBE_ACTION_PERMISSION_RULES={
  ...
  openMonthlyTargetCreate:['sunbed_settings','edit'], openMonthlyTargetEdit:['sunbed_settings','edit'], saveMonthlyTarget:['sunbed_settings','edit'], deleteMonthlyTargetStack:['sunbed_settings','edit'], saveOpeningHours:['sunbed_settings','edit'],
  openBooking:['treatment_room_diary','edit'], saveBooking:['treatment_room_diary','edit'],
  addClinic:['clinic_days','edit'], saveNewClinicDay:['clinic_days','edit'], saveClinicDayEdits:['clinic_days','edit'], deleteClinicDay:['clinic_days','edit'], copyClinicDay:['clinic_days','edit'],
  addProduct:['treatment_booking_settings','edit'], saveNewProduct:['treatment_booking_settings','edit'], deleteCurrentProduct:['treatment_booking_settings','edit'], editCurrentProduct:['treatment_booking_settings','edit'],
  addTreatmentToCurrentProduct:['treatment_booking_settings','edit'], openTreatmentEdit:['treatment_booking_settings','edit'], saveNewTreatment:['treatment_booking_settings','edit'], deleteTreatment:['treatment_booking_settings','edit'],
  addRenter:['treatment_booking_settings','edit'], openRenterEdit:['treatment_booking_settings','edit'], saveNewRenter:['treatment_booking_settings','edit'], deleteRenter:['treatment_booking_settings','edit'],
  openCustomerCreate:['treatment_booking_settings','edit'], saveCustomer:['treatment_booking_settings','edit'], deleteCustomer:['treatment_booking_settings','edit'], completeBlockPurchase:['treatment_booking_settings','edit'],
  openStaffMemberCreate:['staff_members','edit'], openStaffMemberEdit:['staff_members','edit'], saveStaffMember:['staff_members','edit'], deleteStaffMember:['staff_members','edit'],
