...
function sessionCustomerChanged(){let c=data.customers.find(x=>x.id===document.getElementById('sessionCustomerId').value);document.getElementById('sessionCustomerBalance').textContent=c?`${c.minutesLeft} minutes left on account.`:'Select a customer to see account minutes, or leave blank.'}
